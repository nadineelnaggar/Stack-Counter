...
file_name = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'.txt'
excel_name = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'.xlsx'
modelname = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'_MODEL.pth'
optimname = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'_OPTIMISER.pth'
train_log= 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'_TRAIN_LOG.txt'
test_log = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'_TEST_LOG.txt'
long_test_log = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'_LONG_TEST_LOG.txt'
plot_name = 'Dyck1_'+task+'_'+str(num_bracket_pairs)+'_bracket_pairs_'+model_name+'_'+output_activation+'_'+str(num_layers)+'layers_'+str(hidden_size)+'hidden_units_'+initialisation+'_initialisation_'+use_optimiser+'_lr='+str(learning_rate)+'_'+str(num_epochs)+'epochs_'+'bias_'+str(bias)+'_'+frozen_layers+'_PLOT.png'
